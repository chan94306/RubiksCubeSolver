...
public class ImageUtilities {
	 ...
	 * For Model
	 */
	public static void updateAverageGridPaints(GridView gridView, int[] RGBData, int margin, int mImageWidth, int mImageHeight) {
		...
		for (int m = 0; m < GRIDSIZE; m++) {
			for (int n = 0; n < GRIDSIZE; n++) {
				...
				gridView.setFillColor(m, n, 255, (int) redMean, (int) greenMean, (int) blueMean);
			}
		}
	}
